    ...
    for (const msg of messages) {
      ...
      try {
        if (fileBuffer) {
          ...
          const data = await axios.post('https://api-orquestador-577166035685.us-central1.run.app/webhook/orquestador', fileBuffer, {
            headers: {
          ...
          const data = await axios.post(
            'https://api-orquestador-577166035685.us-central1.run.app/webhook/orquestador',
            text,
            {
              headers: {
